    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>Drible 1</td>
                    <td>Passos para fazer o drible 1</td>
                    <td><button class="link-button" data-url="URL_DO_LINK_AQUI">Abrir</button></td>
                </tr>
                <tr>
                    <td>Drible 2</td>
                    <td>Passos para fazer o drible 2</td>
                    <td><button class="link-button" data-url="URL_DO_LINK_AQUI">Abrir</button></td>
                </tr>
                <tr>
                    <td>Drible 3</td>
                    <td>Passos para fazer o drible 3</td>
                    <td><button class="link-button" data-url="URL_DO_LINK_AQUI">Abrir</button></td>
                </tr>
                <tr>
                    <td>Drible 4</td>
                ...
                <tr>
                    <td>Drible 10</td>
                    <td>Passos para fazer o drible 10</td>
                    <td><button class="link-button" data-url="URL_DO_LINK_AQUI">Abrir</button></td>
                </tr>
            </tbody>
        </table>
